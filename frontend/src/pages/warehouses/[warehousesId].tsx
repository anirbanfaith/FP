...
const EditWarehouses = () => {
  ...
  const { warehousesId } = router.query

  useEffect(() => {
    dispatch(fetch({ id: warehousesId }))
  }, [warehousesId])
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: warehousesId, data }))
...
EditWarehouses.getLayout = function getLayout(page: ReactElement) {
  return (
      <LayoutAuthenticated>
          {page}
      </LayoutAuthenticated>
