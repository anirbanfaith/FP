          ...
          <SectionMain>
            ...
            <CardBox>
                ...
                <div className={'mb-4'}>
                    ...
                    <p>{reports?.type ?? 'No data'}</p>
                </div>

                <FormField label='StartDate'>
                    {reports.start_date ? <DatePicker
                      dateFormat="yyyy-MM-dd hh:mm"
                      showTimeSelect
                      selected={reports.start_date ?
                        new Date(
                          dayjs(reports.start_date).format('YYYY-MM-DD hh:mm'),
                        ) : null
                      }
                      disabled
                    /> : <p>No StartDate</p>}
                ...
                <FormField label='EndDate'>
                    {reports.end_date ? <DatePicker
                      dateFormat="yyyy-MM-dd hh:mm"
                      showTimeSelect
                      selected={reports.end_date ?
                        new Date(
                          dayjs(reports.end_date).format('YYYY-MM-DD hh:mm'),
                        ) : null
                      }
                      disabled
                    /> : <p>No EndDate</p>}
