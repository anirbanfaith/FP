                        ...
                        <div className={`flex rounded dark:bg-dark-900 border items-center overflow-hidden`}>
                          ...
                          >
                            ...
                            <div className={'flex-1 px-3'}>
                                <p className={'text-xs text-gray-500'}>TrackingID</p>
                                <p className={'line-clamp-2'}>{ item.tracking_id }</p>
                            </div>

                            <div className={'flex-1 px-3'}>
                                <p className={'text-xs text-gray-500'}>Seller</p>
                                <p className={'line-clamp-2'}>{ dataFormatter.sellersOneListFormatter(item.seller) }</p>
                            </div>

                            <div className={'flex-1 px-3'}>
                                <p className={'text-xs text-gray-500'}>Courier</p>
                                <p className={'line-clamp-2'}>{ dataFormatter.couriersOneListFormatter(item.courier) }</p>
                            </div>

                            <div className={'flex-1 px-3'}>
                                <p className={'text-xs text-gray-500'}>PickupDate</p>
                                <p className={'line-clamp-2'}>{ dataFormatter.dateTimeFormatter(item.pickup_date) }</p>
                            </div>
